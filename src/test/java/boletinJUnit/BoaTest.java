...
import boletinJUnit.Boa;

public class BoaTest {

	@ParameterizedTest
	@MethodSource("datosBoa")
	...
	private static Stream<Arguments> datosBoa() {
		return Stream.of(
	...
	private static Stream<Arguments> datosJaula() {
		return Stream.of(
				Arguments.of(8, 10, true), 
